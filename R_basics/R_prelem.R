...
# Assign sentence to variable name.
sentence2 <- "I'm having a truly joyous time in this class!"
...
#Print two_sentences to the consolse.
two_sentences

# Operators ---------------------------------------------------------------

# Operators are symbols that do things. You'll remember the assignment operator (<-) from up above. Mathematical operators are the kind you already know the best. They include your basic addition (+), subtraction (-), multiplication(*), and division (/). With meathematical operators, you can turn R into the most overpowered calculator there is.

# Add 1 and 2
1 + 2

# This problem was famous on Twitter recently (https://twitter.com/emma__jenner1/status/1427752157353189380). It turns out a lot of folks don't remember order of operations.
50 + 50 - 25 * 0 + 2 + 2
...
# Stem sentence1 and find out how many chracters are in the stem.
